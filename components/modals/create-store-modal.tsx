...
const CreateStoreModal: React.FC<CreateStoreModalProps> = ({}) => {
  ...
  const { mutate: createStore, isLoading } = useMutation({
    mutationFn: async (payload: z.infer<typeof generalSettingsValidator>) => {
  ...
  const onSubmit = (values: z.infer<typeof generalSettingsValidator>) => {
    createStore(values)
  }
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent dir="rtl">
          ...
          <ScrollArea dir="rtl" className="h-[400px] pl-4">
            <Form {...form}>
              <form
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        شناسه ی یکتای فروشگاه شما قابل تغییر نخواهد بود
                      </FormDescription>
                      <FormControl>
                        <Input className="w-[300px]" {...field} />
                      </FormControl>
