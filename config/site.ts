...
export const siteConfig = {
  ...
  benefits: [
    ...
    },
    {
      ...
      description:
        "برای استفاده از امکانات پاپ وب شما نیاز به هیچ گونه دانش فنی ای در زمینه طراحی سایت نخواهید داشت.",
    },
    {
      icon: TbFreeRights,
      title: "شروع رایگان",
  ...
  features: [
    {
      ...
      description:
        "فروشگاه خود را به انواع درگاه بانکی مستقیم و غیر مستقیم و همچنین درگاه های پرداخت اقساطی مانند اسنپ پی متصل کنید.",
    },
  ],
  faq: [
    {
